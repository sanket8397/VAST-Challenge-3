...
for participant in participants:
    ...
    p_food_df['venueId'] = buildings

    # Aggregate amount on participant, date and school venueId
    aggr_p_food_df = p_food_df.groupby(['participantId', 'date', 'venueId']).agg({'amount': 'sum'})
...
# Convert venueId to integer
result_df['venueId'] = result_df['venueId'].astype('int')
